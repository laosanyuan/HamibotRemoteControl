...
namespace HamibotRemoteControl.ViewModels
{
    class ViewModelLocator
    {
        ...
        static ViewModelLocator()
        {
            ...
            _builder.RegisterType<EditSchemePageViewModel>().AsSelf().SingleInstance();
        ...
        public EditSchemePageViewModel EditSchemePage => _container.Resolve<EditSchemePageViewModel>();
    }
}
